...
|---|---|---|---|
|  MRI Pulse Sequence Development | Designed scanner-ready GRE pulse sequence — k-space trajectory, hardware validation, image reconstruction via FFT | Python, PyPulseq, NumPy | [GitHub](https://github.com/kuljit-medtech/PulseSeq) |
